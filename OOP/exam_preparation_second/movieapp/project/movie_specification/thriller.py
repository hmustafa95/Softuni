from OOP.exam_preparation_second.movieapp.project.movie_specification.movie import Movie
from OOP.exam_preparation_second.movieapp.project.user import User
